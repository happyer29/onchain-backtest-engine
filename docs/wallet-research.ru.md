...
На сохранённом снимке из 97 040 строк и 10 075 подписантов проверено окно
...
[Замеры ёмкости](research-capacity.md) относятся к этой выборке; более крупный
или плотный снимок всё ещё может превысить лимиты.
