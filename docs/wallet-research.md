...
Leave the signer field empty to analyze all observed signers. Graph scope is
chosen separately from table pagination. Larger or denser snapshots can exceed
the documented resource guards; narrow the range or select signers explicitly.
