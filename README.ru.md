...
портфель или доказательство прибыльности. Показан английский язык по умолчанию.

![Общий React-экран результатов стратегии](docs/assets/strategy-results.png)

![Детали сделки с маркеткапом, сигналом и фактическими исходами попыток](docs/assets/trade-detail.png)
